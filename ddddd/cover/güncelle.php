  ...
  <main class="px-0 w-100">
      ...
      ?>
        <tr>
          ...
          <td><?php  echo $randevucek["ad"]?></td>
          <td><?php  echo $randevucek["soyad"]?></td>
          <td><?php  echo $randevucek["tc"]?></td>
          <td><?php  echo $randevucek["telefon"]?></td>
          <td><form action="islem.php" method="GET"><button style="background-color:red; color:white; border:0; border-radius:10px; padding:10px;" name="deletebtn" value="<?php  echo $randevucek["randevu_id"]?>">Sil</button></form></td>  
          <td><form action="updateform.php" method="GET"><a href="updateform.php"><button  style="background-color:gray; color:white; border:0; padding:10px; border-radius:10px;" name="randevu_id" value="<?php  echo $randevucek["randevu_id"]?>">Güncelle</button></a></form></td>  
        </tr>
        <?php } ?>
      </table>
