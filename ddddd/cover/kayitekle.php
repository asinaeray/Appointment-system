...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-5">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        ...
        <a class="nav-link fw-bold py-1 px-0 active" aria-current="page"  href="kayitekle.php">Kayıt Ekle</a>
        <a class="nav-link fw-bold py-1 px-0" href="güncelle.php">Güncelle</a>
      </nav>
    </div>
  </header>
  ...
  <div class="col-12">
    <input type="text" class="form-control"  placeholder="Tc:" name="tc">
  </div>
  <div class="col-12">
    <input type="text" class="form-control" placeholder="Telefon:" name="telefon">
  </div>
  <div class="col-12">
    <button type="submit" style="background-color:gray; color:white; padding:10px; border:0; border-radius:10px;" name="kaydetbtn">Kaydet</button>
  </div>
</form>
